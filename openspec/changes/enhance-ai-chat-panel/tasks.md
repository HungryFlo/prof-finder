...
- [ ] 1.2 Run `openspec validate enhance-ai-chat-panel --strict --no-interactive`
...
## 6. Validation
- [ ] 6.1 手动验证：空状态显示 suggestion pills 且可点击发送
- [ ] 6.2 手动验证：长对话中回到底部按钮正常工作
- [ ] 6.3 手动验证：AI 回复下方复制和重新生成按钮正常工作
- [ ] 6.4 Run `openspec validate enhance-ai-chat-panel --strict --no-interactive`
