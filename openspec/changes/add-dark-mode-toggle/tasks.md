...
- [ ] 1.2 Run `openspec validate add-dark-mode-toggle --strict --no-interactive`
...
## 4. Validation
- [ ] 4.1 手动验证：点击切换按钮在 light/dark 间切换
- [ ] 4.2 手动验证：刷新后主题偏好保持
- [ ] 4.3 手动验证：Naive UI 组件在 dark 模式下正确渲染
- [ ] 4.4 Run `openspec validate add-dark-mode-toggle --strict --no-interactive`
