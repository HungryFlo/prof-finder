...
- [x] 1.2 Run `openspec validate add-breadcrumb-navigation --strict --no-interactive`
...
## 5. Validation
- [x] 5.1 手动验证：列表页面面包屑显示正确（如 首页 > 教授管理）
- [x] 5.2 手动验证：详情页面面包屑显示正确（如 首页 > 教授管理 > {name}）
- [x] 5.3 手动验证：面包屑可点击跳转
- [x] 5.4 手动验证：语言切换后面包屑标签更新
- [x] 5.5 Run `openspec validate add-breadcrumb-navigation --strict --no-interactive`
