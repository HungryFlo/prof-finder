...
- [x] 1.2 Run `openspec validate refactor-password-ui --strict --no-interactive`
...
## 6. Validation
- [x] 6.1 手动验证：注册页面密码校验正常
- [x] 6.2 手动验证：强制修改密码页面校验正常
- [x] 6.3 手动验证：设置页面修改密码校验正常且有实时提示
- [x] 6.4 Run `openspec validate refactor-password-ui --strict --no-interactive`
