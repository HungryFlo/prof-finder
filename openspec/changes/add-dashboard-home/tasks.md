...
- [ ] 1.2 Run `openspec validate add-dashboard-home --strict --no-interactive`
...
## 7. Validation
- [ ] 7.1 手动验证：访问 `/` 显示 Dashboard 而非重定向
- [ ] 7.2 手动验证：统计数据正确显示
- [ ] 7.3 手动验证：快速操作按钮跳转正确
- [ ] 7.4 手动验证：激励话语随语言切换
- [ ] 7.5 Run `openspec validate add-dashboard-home --strict --no-interactive`
